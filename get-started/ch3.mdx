...
description: "Explore the lower-level root characteristics of JavaScript including iteration, closure, this, and prototypes that underpin virtually every line of code."
---
...
<Note>
  Be aware: this chapter digs much deeper than you're likely used to thinking about a programming language. My goal is to help you appreciate the core of how JS works, what makes it tick.
</Note>
...
The three objects (`otherHomework`, `homework`, and `Object.prototype`) are linked in a prototype chain.
