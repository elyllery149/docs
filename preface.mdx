---
title: Preface
description: The motivations, philosophy, and approach behind the You Don't Know JS Yet book series
---
...
<Card title="The Toolbox Analogy" icon="toolbox" color="#fc9304">
...
I'm presenting a gentle but earnest challenge to you the reader, to set aside the assumptions you have about JS, and approach it with fresh eyes and an invigorated curiosity that leads you to ask *why* for every line of code you write.
...
<Card title="Core Philosophy" icon="lightbulb" color="#f46404">
...
1. **Take one chapter** - Read it completely through start to finish
2. **Go back and re-read it** section by section
3. **Practice** - Stop between each section and practice the code or ideas from that section
4. **Digest** - For larger concepts, expect to spend several days digesting, re-reading, practicing, then digesting some more
...
Don't binge these books; be patient and spread out your reading. Here are some ways to engage more deeply:

- **Interleave reading** with lots of practice on real code in your job or on projects you participate in
...
<Card title="Own Your Opinions" icon="comments" color="#fcb47c">
