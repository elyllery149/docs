...
description: "Practice exercises to solidify your understanding of comparisons, closure, and prototypes with suggested solutions."
---
...
<Note>
  The best way to learn code is to write code. Don't just read these exercises—actually try to solve them yourself first!
</Note>
...
<Tip>
  Try to solve this yourself first. Once you have code that works, *compare* your solution(s) to the code in "Suggested Solutions" at the end of this appendix.
</Tip>
