---
title: "Chapter 5: Delegation"
description: "Discover delegation as an alternative to class-orientation - learn to compose peer objects through prototypes and dynamic this context for flexible, powerful code organization."
---
...
Let's evolve this pattern step by step:
...
- **Virtual composition**: Behaviors are composed at runtime through `this` context sharing, rather than at author-time through class hierarchies  
- **OLOO pattern**: "Objects Linked to Other Objects" emphasizes the simplicity of objects cooperating with other objects
- **Flexibility**: The `this` keyword and `[[Prototype]]` chain provide tremendous flexibility for dynamic behavior composition

While delegation isn't mainstream in the JavaScript community, understanding this pattern deepens your knowledge of how the language's core mechanisms work -- and that understanding benefits you regardless of which patterns you choose to use in your own code.
